...
var kKeywords = [
    ...
    // Numeric opcodes.
    "i(32|64)\\.(main(8|16)|(load(8|16)_[su]))",
    "i64\\.(load32_[su]|store32)",
    "[fi](32|64)\\.(const|load|main)",
    ...
    "i(32|64)\\.atomic\\.(load((8|16)_u)?|main(8|16)?|rmw(\\.(a[dn]d|sub|x?or|(cmp)?xchg)|(8|16)\\.(a[dn]d|sub|x?or|(cmp)?xchg)_u))",
    // SIMD.
    "v128\\.load(8x8|16x4|32x2)_[su]",
    "v128\\.load(8|16|32|64)_splat",
    "v128\\.(load|main)(8|16|32|64)_lane",
    "v128\\.load(32|64)_zero",
    "v128\.(load|main|const|not|andnot|and|or|xor|bitselect|any_true)",
