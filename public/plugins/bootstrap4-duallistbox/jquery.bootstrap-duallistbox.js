...
(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      eventMoveOverride: false,                                                           // boolean, allows client to unbind default event behaviour and run their own instead
      eventMoveAllOverride: false,                                                        // boolean, allows client to unbind default event behaviour and run their own instead
      eventRemoveOverride: false,                                                         // boolean, allows client to unbind default event behaviour and run their own instead
      eventRemoveAllOverride: false,                                                      // boolean, allows client to unbind default event behaviour and run their own instead
    ...
    if (options === undefined || typeof options === 'object') {
      return this.each(function () {
        ...
        if (!$(this).is('select')) {
          ...
          // and main the plugin instance in the elements jQuery data object.
