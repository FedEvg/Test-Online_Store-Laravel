...
DataTable.ext.buttons.copyHtml5 = {
	...
	action: function ( e, dt, button, config ) {
		...
		// Otherwise we show the text box and instruct the client to use it
		...
		// Select the text so when the client activates their system clipboard
		// it will copy that text
		textarea[0].focus();
		textarea[0].select();

		// Event to hide the message when the client is done
