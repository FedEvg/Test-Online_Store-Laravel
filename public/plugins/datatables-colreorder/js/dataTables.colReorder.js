...
$.extend( ColReorder.prototype, {
	...
	/**
	 * Enable / disable end client interaction
	 */
	...
	/**
	 * Disable end client interaction
	 */
	fnDisable: function ()
	{
		this.s.enable = false;
	...
	"_fnMouseMove": function ( e )
	{
		...
		if ( this.dom.drag === null )
		{
			 ...
			 * point - this allows the client to make small mouse movements when sorting and not have a
	...
	/**
	 * Copy the TH element that is being drags so the client has the idea that they are actually
...
ColReorder.defaults = {
	...
	/**
	 * Redraw the table's column ordering as the end client draws the column
