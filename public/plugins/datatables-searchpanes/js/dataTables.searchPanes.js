...
(function () {
    ...
    var SearchPane = /** @class */ (function () {
         ...
         *
         * @param display the value to be displayed to the client
        ...
        SearchPane.prototype._setListeners = function () {
            ...
            this.s.dtPane.off('client-select.dtsp');
            this.s.dtPane.on('client-select.dtsp', function (e, _dt, type, cell, originalEvent) {
                ...
                columnDefs: [
                    {
                        ...
                        // This is null if not defined by the client, meaning that automatic type detection
                        //  would take place
         ...
         *
         * @returns {object} The options for the row extended to include the options from the client.
         */
