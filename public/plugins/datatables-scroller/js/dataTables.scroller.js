...
var Scroller = function ( dt, opts ) {
	...
	this.s = {
		 ...
		 * and when the client scrolls the viewport in order to stop the cookie set taking too much
		 * CPU!
		 *  @type     int
		 *  @default  0
		 */
...
$.extend( Scroller.prototype, {
	...
	/**
	 * Calculate and main information about how many rows are to be displayed
	...
	*/
	...
	construct: function ()
	{
		...
		// In iOS we catch the touchstart event in case the client tries to scroll
	 ...
	 * table that has been drawn so the client can scroll the whole data set.
	 *
...
Scroller.defaults = {
	 ...
	 * allow the data to look continuous to a client scrolling through the data). If given as 0
