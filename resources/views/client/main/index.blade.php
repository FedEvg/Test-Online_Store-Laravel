                                ...
                                <div class="product-img default-overlay mb-25">
                                    <a href="product-details.html">
                                        <img class="default-img"
                                             src="{{ asset('assets/images/product/product-3.jpg') }}" alt="">
                                        <img class="hover-img"
                                             src="{{ asset('assets/images/product/product-3-2.jpg') }}" alt="">
                                    </a>
                        ...
                        <div class="row">
                            ...
                            <div class="custom-col-68-shop">
                                <div class="shop-list-content ml-20">
                                    ...
                                    <p>Composition: 50% cotton,45% polyester, 5% polyamide. Filling: 100% polyester.
                                        Hood fur: 64% acrylic,23% modacrylic,13% polyester</p>
                            ...
                            <div class="custom-col-32-shop">
                                <div class="product-wrap">
                                    <div class="product-img default-overlay">
                                        <a href="product-details.html">
                                            <img class="default-img"
                                                 src="{{ asset('assets/images/product/product-2.jpg') }}" alt="">
                                            <img class="hover-img"
                                                 src="{{ asset('assets/images/product/product-2-2.jpg') }}" alt="">
                                        </a>
                                        <div class="shop-list-quickview">
                                            <a data-toggle="modal" data-target="#exampleModal" href="#"><i
                                                    class="fa fa-eye"></i><span>Quick Shop</span></a>
