                                    ...
                                    <div class="mega-menu-inner">
                                        <div class="demo-item mb-40">
                                            <div class="demo-item-img">
                                                <a href="index.html">
                                                    <img src="{{ asset("assets/images/menu/h-1.jpg") }}" alt="demo-img">
                                                    <span>View Demo</span>
                                                </a>
                                            </div>
                                        ...
                                        <div class="demo-item mb-40">
                                            <div class="demo-item-img">
                                                <a href="index-2.html">
                                                    <img src="{{ asset("assets/images/menu/h-2.jpg") }}" alt="demo-img">
                                                    <span>View Demo</span>
                                                </a>
                                            </div>
                                            <div class="demo-item-content">
                                        ...
                                        <div class="demo-item mb-40">
                                            <div class="demo-item-img">
                                                <a href="index-3.html">
                                                    <img src="{{ asset("assets/images/menu/h-3.jpg") }}" alt="demo-img">
                                                    <span>View Demo</span>
                                                </a>
                                            </div>
                                            <div class="demo-item-content">
                                        ...
                                        <div class="demo-item mb-40">
                                            <div class="demo-item-img">
                                                <a href="index-4.html">
                                                    <img src="{{ asset("assets/images/menu/h-4.jpg") }}" alt="demo-img">
                                                    <span>View Demo</span>
                                                </a>
                                            </div>
                                            <div class="demo-item-content">
                                        ...
                                        <div class="demo-item mb-40">
                                            <div class="demo-item-img">
                                                <a href="index-5.html">
                                                    <img src="{{ asset("assets/images/menu/h-5.jpg") }}" alt="demo-img">
                                                    <span>View Demo</span>
                                                </a>
                                            </div>
                                            <div class="demo-item-content">
                                        ...
                                        <div class="demo-item mb-40">
                                            <div class="demo-item-img">
                                                <a href="index-6.html">
                                                    <img src="{{ asset("assets/images/menu/h-6.jpg") }}" alt="demo-img">
                                                    <span>View Demo</span>
                                                </a>
                                            </div>
                                            <div class="demo-item-content">
                                        ...
                                        <div class="demo-item mb-40">
                                            <div class="demo-item-img">
                                                <a href="index-7.html">
                                                    <img src="{{ asset("assets/images/menu/h-7.jpg") }}" alt="demo-img">
                                                    <span>View Demo</span>
                                                </a>
                                            </div>
                                            <div class="demo-item-content">
                                        ...
                                        <div class="demo-item mb-40">
                                            <div class="demo-item-img">
                                                <a href="index-8.html">
                                                    <img src="{{ asset("assets/images/menu/h-8.jpg") }}" alt="demo-img">
                                                    <span>View Demo</span>
                                                </a>
                                            </div>
                                            <div class="demo-item-content">
                                        ...
                                        <div class="demo-item mb-40">
                                            <div class="demo-item-img">
                                                <a href="index-9.html">
                                                    <img src="{{ asset("assets/images/menu/h-9.jpg") }}" alt="demo-img">
                                                    <span>View Demo</span>
                                                </a>
                                            </div>
                                            <div class="demo-item-content">
                                        ...
                                        <div class="demo-item mb-40">
                                            <div class="demo-item-img">
                                                <a href="index-10.html">
                                                    <img src="{{ asset("assets/images/menu/h-10.jpg") }}" alt="demo-img">
                                                    <span>View Demo</span>
                                                </a>
                                            </div>
                                            <div class="demo-item-content">
                                        ...
                                        <div class="demo-item mb-40">
                                            <div class="demo-item-img">
                                                <a href="index-11.html">
                                                    <img src="{{ asset("assets/images/menu/h-11.jpg") }}" alt="demo-img">
                                                    <span>View Demo</span>
                                                </a>
                                            </div>
                                            <div class="demo-item-content">
                                        ...
                                        <div class="demo-item mb-40">
                                            <div class="demo-item-img">
                                                <a href="index-12.html">
                                                    <img src="{{ asset("assets/images/menu/h-12.jpg") }}" alt="demo-img">
                                                    <span>View Demo</span>
                                                </a>
                                            </div>
                                            <div class="demo-item-content">
                                        ...
                                        <div class="demo-item mb-40">
                                            <div class="demo-item-img">
                                                <a href="index-13.html">
                                                    <img src="{{ asset("assets/images/menu/h-13.jpg") }}" alt="demo-img">
                                                    <span>View Demo</span>
                                                </a>
                                            </div>
                                            <div class="demo-item-content">
                                        ...
                                        <div class="demo-item mb-40">
                                            <div class="demo-item-img">
                                                <a href="index-14.html">
                                                    <img src="{{ asset("assets/images/menu/h-14.jpg") }}" alt="demo-img">
                                                    <span>View Demo</span>
                                                </a>
                                            </div>
                                            <div class="demo-item-content">
                                        ...
                                        <div class="demo-item mb-40">
                                            <div class="demo-item-img">
                                                <a href="index-15.html">
                                                    <img src="{{ asset("assets/images/menu/h-15.jpg") }}" alt="demo-img">
                                                    <span>View Demo</span>
                                                </a>
                                            </div>
                                            <div class="demo-item-content">
                                        ...
                                        <div class="demo-item mb-40">
                                            <div class="demo-item-img">
                                                <a href="index-16.html">
                                                    <img src="{{ asset("assets/images/menu/h-16.jpg") }}" alt="demo-img">
                                                    <span>View Demo</span>
                                                </a>
                                            </div>
                                            <div class="demo-item-content">
                                        ...
                                        <div class="demo-item mb-40">
                                            <div class="demo-item-img">
                                                <a href="index-17.html">
                                                    <img src="{{ asset("assets/images/menu/h-17.jpg") }}" alt="demo-img">
                                                    <span>View Demo</span>
                                                </a>
                                            </div>
                                            <div class="demo-item-content">
                                        ...
                                        <div class="demo-item mb-40">
                                            <div class="demo-item-img">
                                                <a href="index-18.html">
                                                    <img src="{{ asset("assets/images/menu/h-18.jpg") }}" alt="demo-img">
                                                    <span>View Demo</span>
                                                </a>
                                            </div>
                                            <div class="demo-item-content">
                                        ...
                                        <div class="demo-item mb-40">
                                            <div class="demo-item-img">
                                                <a href="index-19.html">
                                                    <img src="{{ asset("assets/images/menu/h-19.jpg") }}" alt="demo-img">
                                                    <span>View Demo</span>
                                                </a>
                                            </div>
                                            <div class="demo-item-content">
                                ...
                                <ul class="mega-menu-style-2 mega-menu-width2 menu-negative-mrg1">
                                    ...
                                    <li class="mega-menu-sub-width37">
                                        <div class="banner-menu-content-wrap default-overlay">
                                            <a href="product-details.html"><img src="{{ asset("assets/images/menu/banner-header.jpg") }}" alt="banner"></a>
